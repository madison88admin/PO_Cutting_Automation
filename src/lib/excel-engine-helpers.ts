export const FALLBACK_COLUMN_ALIASES: Record<string, string> = {
    ...
    'final po cut#': 'ignore',
    'pr number/ dummy po number': 'purchaseOrder',
    'pr item number/ dummy po cut': 'lineItem',
    'dc/ plant': 'vendorName',
    'erp factory code': 'productSupplier',
    'erp vendor code': 'ignore',
    'missing pr quantity': 'ignore',
    'buy month': 'ignore',
    'buy year': 'ignore',
    'buy description': 'ignore',
    'production priority': 'ignore',
    'po conversion status': 'ignore',
    'po cut': 'ignore',
    'factory short name': 'vendorName',
    'po type': 'ignore',
    'master po#': 'purchaseOrder',
    'final po cut #': 'buyerPoNumber',
    'final factory': 'productSupplier',
    'final vendor name': 'vendorName',
    'style color': 'colour',
    'colorway name': 'colour',
    'total quantity': 'quantity',
    'transportation mode description': 'transportMethod',
    ...
    'purchase req qty (plan qty for pr upload)': 'quantity',
    'consensus quantity': 'quantity',
    'item number': 'product',
    'dev #': 'productCustomerRef',
    'final delivery date': 'exFtyDate',
    'order qty': 'quantity',
