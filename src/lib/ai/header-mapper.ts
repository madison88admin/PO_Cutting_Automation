...
const HEADER_PATTERNS: { field: string; patterns: string[] }[] = [
    ...
    { field: 'buyer_style_number', patterns: ['jde style', 'material style', 'style#', 'style #', 'style code', 'style number', 'style no', 'style no.', 'style ref', 'style reference', 'item number', 'article', 'model', 'model no', 'model number', 'dev #', 'item', 'style'] },
    ...
    { field: 'factory', patterns: ['final factory name', 'final factory', 'final vendor name', 'final vendor', 'factory name', 'erp factory code', 'factory code', 'vendor code', 'factory', 'vendor plnt (conf plnt)', 'confirmed vendor plnt', 'vendor name', 'vendor', 'supplier', 'manufacturer'] },
