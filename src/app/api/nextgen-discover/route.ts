...
import { createWriteClient, isWriteEnabled } from "@/lib/nextgen";
import { NextGenClient as WriteNextGenClient } from "@/lib/nextgen/write-client";
...
export async function GET(req: NextRequest) {
    try {
        ...
        const client: WriteNextGenClient = env === 'prod'
            ? new WriteNextGenClient()
            : (isWriteEnabled() ? createWriteClient() : new WriteNextGenClient());
